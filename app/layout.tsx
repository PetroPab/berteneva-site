...
export const metadata: Metadata = {
  title: 'Бетнева Studio — дизайн и разработка',
  description:
    'Студия графического дизайна и веб-разработки. Логотипы, айдентика, упаковка, сайты под ключ для малого бизнеса.',
