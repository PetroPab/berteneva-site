...
const steps = [
  ...
  },
  {
    ...
    title: 'Концепт',
    description:
      'Показываю направление. Обсуждаем, корректируем, фиксируем — прежде чем идти дальше.',
  },
  {
    number: '03',
    title: 'Реализация',
    description:
      'Работаю и держу в курсе. Промежуточные показы по договорённости.',
  },
  {
    number: '04',
    title: 'Сдача',
    description:
      'Передаю файлы или запускаю сайт. Объясняю что и как, чтобы вы могли работать самостоятельно.',
  },
]
